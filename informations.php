...
<main>
    ...
    <div class="container-fluid mx-auto text-center">
        <div class="row col justify-content-center">
            ...
            <img class="text-center pt-3" src="./img/png-clipart-professional-certification-computer-icons-quality-service-quality-icon-service-logo.png" alt="image formateur" style="width:250px;height:250px"/>
        ...
        <div class="row col justify-content-center">
            ...
            <h2 class="text-center p-3">et d'autres..</h2>
        </div>
    </div>
